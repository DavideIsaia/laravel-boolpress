<template>
  <div class="container">
    <h1 class="mt-4 mb-3">Contattaci</h1>
    <div v-if="success" class="alert alert-success">Il messaggio è stato consegnato</div>
    <form>
      <div class="mb-3">
      ...
      <div v-if="loading">Invio in corso, attendere...</div>
